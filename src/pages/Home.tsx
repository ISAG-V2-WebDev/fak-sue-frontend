        ...
        <div className="flex flex-col items-center h-screen">
            <div className="flex flex-col gap-5 my-10 mx-10 w-full max-w-sm px-2">
                ...
                <button
                    ...
                    className="bg-orange-500 hover:bg-orange-400 text-white font-bold text-4xl py-2 px-4 border-b-4 border-orange-700 hover:border-orange-500 rounded-3xl h-20">
                    รับฝาก
                </button>
